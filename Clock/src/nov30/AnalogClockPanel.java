...
public class AnalogClockPanel extends JPanel implements Runnable {
	...
	int scale = 185;// this value can control the size of clock. (inital value:
					// 250)
	...
	protected void paintComponent(Graphics g) {
		...
		// Coordinate origins are by default situated at the top left corner of
		// the
		// component. So, for the convenience of drawing, we'll translate the
		// coordinate
		...
		// this.drawLayout(g2d); //this method is using just for testing during
		// programming.
	}
	...
	private void drawClockFace(Graphics2D g2d) {
		...
		// each at an angular distance of 6 degrees. Because the rotate function
		// of Java
		// Graphics takes a radian value as a parameter, we convert 6 degree to
		// radians
